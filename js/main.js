...
function smoothScrollToAnchor() {
 $("#projects").click(function() {
  TweenMax.to(window, 1.5, { scrollTo: { y: $(window).height() }, ease: Power2.easeOut });
...
$("#contact").click(function() {
  TweenMax.to(window, 1.5, { scrollTo: { y: $('#about').position().top }, ease: Power2.easeOut });
   var temp=$( "a[title='About and Contact']");
  TweenMax.set(temp, {className:"+=active"});
    var temp=$( "a[title='Works']");
  TweenMax.set(temp, {className:"-=active"});
 $("#b-1").click(function() {
  TweenMax.to(window, 1.5, { scrollTo: { y: $('#project-culc').position().top }, ease: Power2.easeOut });
      var temp=$( "a[title='About and Contact']");
  TweenMax.set(temp, {className:"-=active"});
    var temp=$( "a[title='Works']");
  TweenMax.set(temp, {className:"+=active"});
     ...
     $("#b-2").click(function() {
  TweenMax.to(window, 1.5, { scrollTo: { y: $('#project-consensus').position().top }, ease: Power2.easeOut });
      var temp=$( "a[title='About and Contact']");
  TweenMax.set(temp, {className:"-=active"});
    var temp=$( "a[title='Works']");
  TweenMax.set(temp, {className:"+=active"});
     ...
     $("#b-3").click(function() {
  TweenMax.to(window, 1.5, { scrollTo: { y: $('#more').position().top }, ease: Power2.easeOut });
      var temp=$( "a[title='About and Contact']");
  TweenMax.set(temp, {className:"-=active"});
    var temp=$( "a[title='Works']");
  TweenMax.set(temp, {className:"+=active"});
